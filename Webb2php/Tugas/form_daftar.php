	...
	<div>
		...
		<form class="w-75 mt-5 mx-auto p-4 border shadow-sm" method="POST" action="hasil_daftar.php">
			...
			<div class="form-group">
				...
				<input name="Dayati" class="form-control" id="nama_lengkap">
			</div>
			<div class="form-group">
				<label for="email">Email</label>
				<input name="dayatidirwan@gmail.com" class="form-control" id="email">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input name="+6282347089601" class="form-control" id="telepon">
			</div>
